...
=======
    ...
    var MainController = function ($scope, $http, $filter) {
        ...
        $scope.convertToDate = function (stringDate) {
            ...
            console.log("la fecha definida es:"+stringDate+" y convertida es"+dateOut);
            return dateOut;
        };
        $scope.defineDate = function () {
            $scope.project.dueDate=new Date();
            console.log("ESTA ES LA FECHA DUE DATE ANTES DE:" + $scope.project.dueDate);
            $scope.$watch('project.dueDate', function (newValue) {
                $scope.project.dueDate = $filter('date')(newValue, 'yyyy-MM-dd');
            });
            console.log("DESPUES DE LA FUNCION ESTA ES LA FECHA DUE DATE:" + $scope.project.dueDate);
            $scope.$watch('project.installDate', function (newValue) {
                $scope.project.installDate = $filter('date')(newValue, 'yyyy-MM-dd');
            });
        }
        console.log("INSIDE DA BANK");
        ...
        $scope.addProject = function () {
            ...
            $scope.projectData = {
                ...
                , boForm: $scope.project.boForm
                , roForm: $scope.project.roForm
                , saRecieved: $scope.project.saReceived

            };
            console.log('Bank Project DATA:' + $scope.projectData);
            console.log($scope.bankExist);
            //console.log($scope.project);
            if ($scope.bankExist == false) {
                //$scope.apply(function() {
                $scope.addBank();
                $scope.bankExist = true;
                //});
